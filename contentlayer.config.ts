...
const Techstack = defineNestedType(() => ({
  ...
  fields: {
    label: {
      type: "string",
      description: "The label of the stack",
      required: true,
    },
    bgColor: {
      type: "string",
    ...
    textColor: {
      type: "string",
      description: "The text color of the stack",
      required: false,
    },
  },
}));
...
const Projects = defineDocumentType(() => ({
  ...
  fields: {
    ...
    homepage: {
      type: "string",
      description: "The link to the projects homepage",
      required: false,
    },
    repo: {
      type: "string",
      description: "The github repositories of projects",
    },
    maskColor: {
      type: "string",
      description: "The background color for mask",
      required: false,
    },
    stack: {
      type: "list",
